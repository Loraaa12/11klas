[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/7swk1PGX)
# Домашна работа №1
...
Срокът на домашната работа е **до 19.11.2024 (вторник), 23:59:59**. В часът, който
имаме **на 20.11.2024 (сряда)** ще ви извиквам индивидуално част от вас да ми представите
...
- [Задача 1 - `lseek-decode` (200 точки)](./01-lseek-decode/README.md)
- [Задача 2 - `head` (200 точки)](./02-head/README.md)
